...
ent-N14ClothingOuterVexillariusArmor = броня вексиллария
    .desc = Кожаная броня легионера, обвешенная металлическими медалями.
ent-N14ClothingOuterLegionaryArmor = броня легионера
    .desc = Стандартная броня бойца Легиона Цезаря, обеспечивающая защиту от холодного оружия.
ent-N14ClothingOuterDecanusArmor = броня декана
    .desc = Стандартная броня бойца Легиона Цезаря, усилиенная дополнительной железной пластиной.
ent-N14ClothingOuterCenturionArmor = броня центуриона
    .desc = Элитная броня Легиона Цезаря, предназначенная для центурионов и преторианцев.